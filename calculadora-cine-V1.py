...
with st.expander("ℹ️ Información, Privacidad y Contacto"):
    ...
    Los cálculos se realizan tomando como referencia la normativa vigente (convenio colectivo, normativa de la Seguridad Social, tablas de IRPF, conceptos salariales estándar...). 
    
    No obstante, cuando hemos observado contradicciones entre la normativa y prácticas habituales (siempre dentro de la legalidad), hemos realizado los cálculos basándonos en estas últimas para hacer el resultado lo más realista posible.
