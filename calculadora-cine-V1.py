...
# Estilo CSS para uniformizar y mejorar el diseño
st.markdown("""
    <style>
    /* Uniformar fuentes */
    html, body, [class*="st-"] {
...
# --- SISTEMA DE EXTRAS CON RESUMEN INTEGRADO ---
...
# --- SISTEMA DE DIETAS CON RESUMEN INTEGRADO ---
...
# Botón de reinicio más alejado y discreto
st.write("") 
st.write("")
st.write("")
